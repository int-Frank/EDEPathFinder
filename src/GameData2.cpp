...
//typedef std::map<std::string, Engineer> EngineerMap;
//
//struct GameData
//{
//  SystemMap systems;
...
//}
//
//bool ReadSystem(std::ifstream & ifs, std::string & name, System & data)
//{
//  ASSERT_NEXT('{');
//
//  while (true)
...
//}
//
//bool ReadModule(std::ifstream & ifs, std::string & name, Module & data)
//{
//  ASSERT_NEXT('{');
//
//  while (true)
...
//}
//
//bool ReadEngineer(std::ifstream & ifs, std::string & name, Engineer & data)
//{
//  ASSERT_NEXT('{');
//
//  while (true)
